...
def get_portfolio_status(usdkrw):
    try:
        ...
        holdings = {
            "BRK.B":  {"qty": 56,  "type": "us"},
            "GLD":    {"qty": 19,  "type": "us"},
            "SCHD":   {"qty": 10,  "type": "us"},
            "069500.KS": {"qty": 190, "type": "kr", "name": "TIGER S&P500"},
            "360750.KS": {"qty": 353, "type": "kr", "name": "TIGER 배당다우존스"},
        ...
        targets = {
            ...
            "069500.KS": 35, "360750.KS": 10, "102110.KS": 10
        }
...
def main():
    ...
    if portfolio:
        ...
        kakao_text += f"총평가액: {port_total:,.0f}원\n"
    else:
        kakao_text += "조회 실패\n"
